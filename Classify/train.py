...
from data.DiseaseData import Diseasedata
  ...
  for epoch in range(num_epochs):
    ...
    for phase in ['train', 'val']:
      ...
      if phase == 'val' and epoch_acc > best_acc:
        best_acc = epoch_acc
        torch.save(model.state_dict(), 'weights/classifier_v1.pth')
        print('Saved model')
...
if __name__ == '__main__':
  ...
  root_path = '/home/hqanh/Potato/Dataset/Classify/'
  data_transforms = {
  ...
  test_dataset = Diseasedata(root_path, transforms=transforms, phase='test')
